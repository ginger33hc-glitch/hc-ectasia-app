"""Patch professional PDF/DOCX exports: remove raw morphology rows and add complete reference tables."""
import reports
...
HC_NOTE="Published Randleman/ERSS table shown for reference. The HC engine intentionally uses HC-modified age and pachymetry rules; the displayed patient score must therefore be read from the HC score breakdown, not reconstructed from the published reference table."
