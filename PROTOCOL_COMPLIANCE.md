...
| LASIK pachymetry bands | Apply explicit HC-modified bands rather than silently inheriting ambiguous published table edges | Not addressed | `<480 µm` hard stop; `480–499 µm` = +2; `500–510 µm` = +1; `>=511 µm` = +0 |
