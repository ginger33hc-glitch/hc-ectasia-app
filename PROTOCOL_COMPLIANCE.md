...
| BAD display | Components and Final BAD-D: `≤1.6` normal, `>1.6–<2.6` suspicious, `≥2.6` abnormal | Previously used Final BAD-D `≥3.0` as the abnormal hard-stop boundary | CER-AI v0.7.51 operational policy: Final BAD-D `≥2.60` is an inclusive abnormal-cornea hard stop / DO NOT PROCEED; individual Df/Db/Dp/Dt/Da components remain contextual and do not independently determine clearance |
