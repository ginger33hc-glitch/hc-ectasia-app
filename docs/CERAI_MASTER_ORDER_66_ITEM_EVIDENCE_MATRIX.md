...
| 37 | ML7/microkeratome planning audit | **PASS (LOCAL)** | Dedicated Four Maps Refractive Anterior Sagittal Curvature K1/K2 supply ML7 keratometry; HWTW remains Four Maps lower-left. No BAD, general-scoring K, or Kmax fallback. Canonical planning owns flap/ring/vacuum/blade/hinge and imports safety constants. |
...
- ML7 uses dedicated Four Maps Refractive Anterior Sagittal Curvature K1/K2 fields and verified Four Maps HWTW. BAD K1/K2 are not required. General scoring K and axis source locks stay independent.
