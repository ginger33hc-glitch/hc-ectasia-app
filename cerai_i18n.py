...
TR = {
    ...
    "final_Kmean_model": "Postoperatif Km modeli",
    "hyperopic_review_level": "Hipermetropik inceleme düzeyi",
    "hyperopic_treatment_component_D": "En yüksek hipermetropik tedavi bileşeni (D)",
    "MYOPIC_0.8_D_PER_D_ESTIMATE": "MİYOPİK 0,8 D/D TAHMİNİ",
    "HYPEROPIC_1.0_D_PER_D_SCREENING": "HİPERMETROPİK 1,0 D/D TARAMA TAHMİNİ",
    "NOT_VALID_FOR_MIXED_ASTIGMATISM": "KARMA ASTİGMATİZMA İÇİN GEÇERLİ DEĞİL",
    "PLATFORM_VERIFICATION": "PLATFORM DOĞRULAMASI",
    "MANDATORY_PLATFORM_OR_SURGEON_CONFIRMATION": "ZORUNLU PLATFORM VEYA CERRAH DOĞRULAMASI",
    ...
    "CER-AI SINGLE-PAGE CONCLUSION REPORT": "CER-AI TEK SAYFALIK SONUÇ RAPORU",
...
TR_CLINICAL = {
    ...
    "Raw PS3 LASIK disposition: DEFER. CER-AI 490-499 µm isolated-thickness exception applied because thinnest pachymetry is the sole PS3 Moderate factor and ERSS, NICE, and Final BAD-D are each PASS or CAUTION.": "Ham PS3 LASIK kararı: ERTELE. En ince pakimetri tek PS3 Orta faktörü olduğu ve ERSS, NICE ile Final BAD-D sonuçlarının her biri UYGUN veya DİKKAT olduğu için CER-AI 490-499 µm izole kalınlık istisnası uygulandı.",
...
REPLACEMENTS = (
    ...
    ('Independent tissue/refractive safety gates', 'Bağımsız doku ve refraktif güvenlik koşulları'),
    ('mixed astigmatism has no validated scalar final-K model', 'karma astigmatizma için doğrulanmış bir skaler postoperatif K modeli yoktur'),
    ('platform-specific prediction or surgeon confirmation required', 'platforma özgü tahmin veya cerrah doğrulaması gereklidir'),
    ('hyperopic Kmean is a conservative 1.0 D/D screening estimate, not a platform prediction', 'hipermetropik Kmean, konservatif bir 1,0 D/D tarama tahminidir; platform tahmini değildir'),
    ('screening Kmean 48.00-48.99 D requires platform verification', '48,00-48,99 D tarama Kmean değeri platform doğrulaması gerektirir'),
    ('screening Kmean >=49.00 D requires platform or surgeon confirmation', 'tarama Kmean değeri ≥49,00 D olduğunda platform veya cerrah doğrulaması gereklidir'),
    (r'hyperopic treatment component >\+4.00 D requires enhanced review', 'hipermetropik tedavi bileşeni >+4,00 D olduğunda ayrıntılı değerlendirme gereklidir'),
