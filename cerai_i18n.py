...
TR_CLINICAL = {
    ...
    "PTI/CTSP thickness-profile morphology: manual surgeon review only; not counted in automated PS3.": "PTI/CTSP kalınlık profili morfolojisi: yalnızca cerrah tarafından değerlendirilir; otomatik PS3 puanlamasına katılmaz.",
    "Relative Thickness Map: manual surgeon review only; not counted in automated PS3.": "Göreli kalınlık haritası: yalnızca cerrah tarafından değerlendirilir; otomatik PS3 puanlamasına katılmaz.",
    "Corneal Thickness Map morphology: manual surgeon review only; not counted in automated PS3.": "Kornea kalınlık haritası morfolojisi: yalnızca cerrah tarafından değerlendirilir; otomatik PS3 puanlamasına katılmaz.",
