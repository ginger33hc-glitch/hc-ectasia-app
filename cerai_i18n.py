...
TR = {
    ...
    "elevation": "Elevasyon",
    "astigmatic_study": "Astigmatizma karşılaştırması",
...
TR_CLINICAL = {
    ...
    "Perpendicular to steep axis": "Dik aksa dik doğrultuda",
    ...
    "Steep K axis is outside 0-180°; the numeric hinge axis was not calculated.": "Dik K aksı 0-180° aralığının dışında; sayısal menteşe aksı hesaplanmadı.",
    "K spread is >4.00 D, but the steep K axis is unavailable; the numeric hinge axis cannot be calculated.": "K farkı >4.00 D ancak dik K aksı mevcut değil; sayısal menteşe aksı hesaplanamaz.",
...
REPLACEMENTS = (
    ...
    ('Perpendicular to steep axis', 'Dik aksa dik doğrultuda'),
    ('hinge axis', 'menteşe aksı'),
    ('superior hinge preferred', 'superior menteşe tercih edilir'),
    ('temporal hinge preferred \\(nasal secondary\\)', 'temporal menteşe tercih edilir (nazal ikincil)'),
    ('oblique meridian — follow the numeric perpendicular hinge axis', 'oblik meridyen — sayısal dik menteşe aksını izleyin'),
    ('CER-AI contingency:', 'CER-AI alternatifi:'),
    ('\\+10 blade; temporal or nasal hinge', '+10 bıçak; temporal veya nazal menteşe'),
    ('may be considered because the perpendicular hinge was documented as anatomically impractical', 'dik doğrultulu menteşenin anatomik olarak uygulanamaz olduğu belgelendiği için düşünülebilir'),
    ('may be considered only if the surgeon determines that the perpendicular hinge is anatomically impractical', 'yalnızca cerrah dik doğrultulu menteşenin anatomik olarak uygulanamaz olduğuna karar verirse düşünülebilir'),
