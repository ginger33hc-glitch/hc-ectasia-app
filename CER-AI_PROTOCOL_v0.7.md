...
When `steepest K - flattest K >4.00 D`, the ML7 hinge axis is perpendicular to the steep meridian. A vertical steep meridian (`60°–120°`, inclusive) prefers a superior hinge. A horizontal steep meridian (`0°–30°` or `150°–180°`, inclusive) prefers a temporal hinge, with nasal as the secondary location. Intervening oblique meridians retain only the numeric perpendicular hinge axis.
