# HC Preoperative Ectasia Risk Assessment — Software Rule Specification v0.7
...
- Actual laser-plan maximum stromal ablation is mandatory. The HC linear myopic EX500 µm/D
...
- The HC Kmean estimate is not applied to mixed astigmatism. The report instructs the surgeon to
