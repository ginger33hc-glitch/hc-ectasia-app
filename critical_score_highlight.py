...
(function(){
 ...
 function appendix(){return `<section class="hc-reference-appendix" id="hcReferenceAppendix"><h3>HC BAD-D reference points</h3><table class="clinical-table"><thead><tr><th>Final BAD-D</th><th>HC interpretation / action</th></tr></thead><tbody><tr><td>≤ 1.6</td><td>NORMAL — no BAD-D gate</td></tr><tr><td>&gt; 1.6 to &lt; 3.0</td><td class="hc-bad-suspicious">SUSPICIOUS — REVIEW / NOT CLEARED</td></tr><tr><td>≥ 3.0</td><td class="hc-bad-abnormal">ABNORMAL CORNEA — DO NOT PROCEED (HC hard stop)</td></tr></tbody></table><p class="note"><strong>BAD-D source rule:</strong> Final BAD-D is read from the Pentacam BAD display. Individual Df/Db/Dp/Dt/Da values are contextual components and are not substitutes for the Final BAD-D gate.</p><h3>Randleman / ERSS scoring reference</h3><table class="clinical-table"><thead><tr><th>Variable</th><th>Finding</th><th>Points</th></tr></thead><tbody><tr><td rowspan="4">Anterior topography</td><td>Normal / symmetrical (round, oval, symmetric bow-tie)</td><td>0</td></tr><tr><td>Asymmetric bow-tie</td><td>1</td></tr><tr><td>Inferior steepening / significant SRA-SRAX</td><td>3</td></tr><tr><td>Abnormal ectatic pattern</td><td>4</td></tr><tr><td rowspan="5">Residual stromal bed</td><td>≥300 µm</td><td>0</td></tr><tr><td>280–&lt;300 µm</td><td>1</td></tr><tr><td>260–&lt;280 µm</td><td>2</td></tr><tr><td>240–&lt;260 µm</td><td>3</td></tr><tr><td>&lt;240 µm</td><td>4</td></tr><tr><td rowspan="4">Age — published ERSS</td><td>18–21 years</td><td>3</td></tr><tr><td>22–25 years</td><td>2</td></tr><tr><td>26–29 years</td><td>1</td></tr><tr><td>≥30 years</td><td>0</td></tr><tr><td rowspan="4">Preoperative CCT — published ERSS</td><td>&lt;450 µm</td><td>4</td></tr><tr><td>451–480 µm</td><td>3</td></tr><tr><td>481–510 µm</td><td>2</td></tr><tr><td>≥510 µm</td><td>0</td></tr><tr><td rowspan="5">MRSE</td><td>≤8 D myopia</td><td>0</td></tr><tr><td>&gt;8 to 10 D myopia</td><td>1</td></tr><tr><td>&gt;10 to 12 D myopia</td><td>2</td></tr><tr><td>&gt;12 to 14 D myopia</td><td>3</td></tr><tr><td>&gt;14 D myopia</td><td>4</td></tr></tbody></table><p class="note"><strong>Critical source separation:</strong> Randleman anterior-topography points must be derived only from an appropriate anterior curvature/topography image (Placido/axial/sagittal/tangential pattern evidence). They must never be derived from the Pentacam BAD display, BAD-D value, elevation-only display, or BAD component indices. BAD-D and ERSS topography are independent inputs.</p><p class="note"><strong>ERSS total:</strong> 0–2 low risk, 3 moderate risk, ≥4 high risk in the published LASIK ERSS. HC operational hard stops remain independent of the numeric ERSS score.</p></section>`;}
 ...
 });const report=document.querySelector('#reportSheet')||document.querySelector('.report-sheet');if(report&&!document.querySelector('#hcReferenceAppendix'))report.insertAdjacentHTML('beforeend',appendix());}
