"""Single canonical CER-AI clinical-disposition contract.

Clinical results have exactly three categories. Workflow/routing states remain
separate and must never be presented as additional clinical risk categories.
"""
...
CLINICAL_STATUSES = frozenset({PASS, CAUTION, STOP_DEFER})
FAVORABLE_PLANNING_STATUSES = frozenset({PASS, CAUTION})
...
def combine_status(current: str, new: str) -> str:
    """Return the more restrictive canonical status."""
