...
class TestERSSCanonicalEngine(unittest.TestCase):
    ...
    def test_high_confidence_visual_category_without_i_s_is_scored(self):
        ...
        self.assertEqual(core.lasik_topography_points("ASYMMETRIC_BOWTIE"),1)
    def test_low_confidence_visual_category_requires_surgeon_confirmation(self):
        maps=eye(True,"ASYMMETRIC_BOWTIE","4maps.jpg");maps["erss_source_read"]="DEDICATED_CURVATURE_PASS";maps["morphology_confidence"]="MODERATE"
        od=core.merge_extractions([result(maps,"4maps.jpg")])["eyes"][0];od["_erss_i_s_gate_required"]=True
