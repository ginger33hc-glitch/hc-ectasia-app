(() => {
  ...
  function installStaticPolicyUI() {
    document.title = "CER-AI — Cornea Ectasia Risk Assessment Intelligence v0.7.65";
    const heading = document.querySelector("body > header h1");
    if (heading) heading.textContent = "CER-AI — Cornea Ectasia Risk Assessment Intelligence v0.7.65";
