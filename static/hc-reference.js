(() => {
  ...
  function installStaticPolicyUI() {
    ...
    if (heading && heading.textContent !== "CER-AI — Corneal Ectasia Risk Assessment Intelligence v0.7.71") {
      heading.textContent = "CER-AI — Corneal Ectasia Risk Assessment Intelligence v0.7.71";
    }
