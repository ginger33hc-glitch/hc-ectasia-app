...
(() => {
  ...
  const TR = {
    ...
    "Surgeon reference — how to choose the Randleman category":"Cerrah referansı — Randleman kategorisi nasıl seçilir",
    "Category":"Kategori","Operational definition":"Operasyonel tanım","ERSS points":"ERSS puanı",
    ...
    "Round, oval, or symmetric bow-tie pattern.":"Yuvarlak, oval veya simetrik bow-tie paterni.",
    "Use the Pentacam Topometric/Keratoconus panel:":"Pentacam Topometric/Keratoconus panelini kullanın:",
    ". Preserve the printed sign. Do not enter ISV, IVA, IHD, IHA, or KISA.":". Yazılı işareti koruyun. ISV, IVA, IHD, IHA veya KISA girmeyin.",
    "On a standard Pentacam":"Standart bir Pentacam",
    "page, assess only the":"sayfasında bu kategori için yalnızca",
    "upper-left Axial/Sagittal Curvature (Front)":"sol üst Axial/Sagittal Curvature (Front)",
    "map for this category.":"haritasını değerlendirin.",
    "Compare the steepest region with the region":"En dik bölgeyi tam",
    "180° opposite":"180° karşısındaki bölgeyle karşılaştırın",
    ". For SRA, assess whether the two bow-tie axes are radially aligned or skewed.":". SRA için iki bow-tie aksının radyal olarak hizalı mı yoksa çarpık mı olduğunu değerlendirin.",
    "Use the separately printed":"Ayrı olarak yazdırılmış",
    "value only. BAD-D, posterior elevation, pachymetry, ISV and IVA are independent data and must not be substituted here.":"değerini kullanın. BAD-D, posterior elevasyon, pakimetri, ISV ve IVA bağımsız verilerdir ve burada bunların yerine kullanılamaz.",
    "Select the":"Aşağıdaki",
    "single highest applicable":"uygun olan tek en yüksek",
    "category below.":"kategoriyi seçin.",
    "Asymmetric steepening in any direction":"Herhangi bir yöndeki asimetrik dikleşmenin, 180° karşı bölgeye göre",
    "versus the region 180° opposite, with":"olması ve",
    "no SRA/SRAX":"SRA/SRAX bulunmaması.",
    ", with or without inferior steepening; or inferior steepening":"; inferior dikleşme olsun veya olmasın; ya da karşı bölgeye göre inferior dikleşme",
    "versus the opposite region while":"ve bu sırada",
    "Unequivocal keratoconus, pellucid marginal degeneration, or forme-fruste keratoconus pattern; or":"Kesin keratokonus, pellusid marjinal dejenerasyon veya forme-fruste keratokonus paterni; ya da",
    "If the correct map, opposite-region comparison, axis relationship, or printed I-S cannot be assessed reliably, do not guess. Leave the category unresolved and upload a clearer source image.":"Doğru harita, karşı bölge karşılaştırması, aks ilişkisi veya yazılı I-S güvenilir biçimde değerlendirilemiyorsa tahmin etmeyin. Kategoriyi çözümlenmemiş bırakın ve daha net bir kaynak görüntü yükleyin.",
    "This is the published Placido-era Randleman/ERSS pattern classification adapted to CERAI's locked anterior-curvature source rule. It is a risk-score input, not a stand-alone diagnosis. Source:":"Bu, CERAI’nin kilitli ön eğrilik kaynak kuralına uyarlanmış, yayımlanmış Placido dönemi Randleman/ERSS patern sınıflandırmasıdır. Bir risk puanı girdisidir; tek başına tanı değildir. Kaynak:",
    "Only one mutually exclusive topography category is sent to the existing Randleman scorer. ABT and inferior-steepening/SRA points are never added.":"Mevcut Randleman puanlayıcısına birbirini dışlayan yalnızca tek bir topografi kategorisi gönderilir. ABT ile inferior dikleşme/SRA puanları hiçbir zaman toplanmaz.",
    ...
    "Analyze images and run CERAI assessment":"Görüntüleri analiz et ve CERAI değerlendirmesini çalıştır",
    "Preoperative manifest refraction is used only for LASIK ERSS MRSE. Intended treatment correction is used for ablation and CERAI treatment-range gates. Unless a different role-specific value is entered, the treatment card’s Düzeltme Miktarı auto-fills both manifest and intended correction. Every refraction field accepts positive or negative values; use the +/− buttons when a phone keyboard has no sign key. Equivalent plus-cylinder entries are safely transposed to minus-cylinder notation for calculation and disclosed in the report.":"Preoperatif manifest refraksiyon yalnızca LASIK ERSS MRSE için kullanılır. Hedef tedavi düzeltmesi ablasyon ve CERAI tedavi aralığı geçitlerinde kullanılır. Role özgü farklı bir değer girilmedikçe tedavi kartındaki Düzeltme Miktarı hem manifest hem hedef düzeltmeyi otomatik doldurur. Tüm refraksiyon alanları pozitif veya negatif değer kabul eder; telefon klavyesinde işaret tuşu yoksa +/− düğmelerini kullanın. Eşdeğer artı silindir girişleri hesaplama için güvenle eksi silindir gösterimine transpoze edilir ve raporda belirtilir.",
    "Download PDF":"PDF indir","Download Word":"Word indir","Print report":"Raporu yazdır",
    "CERAI Clinical Decision Support":"CERAI Klinik Karar Desteği","PREOPERATIVE ECTASIA RISK ASSESSMENT":"PREOPERATİF EKTAZİ RİSK DEĞERLENDİRMESİ",
    ...
    "Final BAD-D / class":"Final BAD-D / sınıf","CERAI-adapted NICE / class":"CERAI uyarlanmış NICE / sınıf",
    ...
    "Randleman I-S / source":"Randleman I-S / kaynak","Validated Randleman topography":"Doğrulanmış Randleman topografisi",
    ...
    "Independent pathways:":"Bağımsız yollar:","Active CERAI pachymetry policy:":"Aktif CERAI pakimetri politikası:","CERAI modification:":"CERAI değişikliği:","Inter-eye tomography:":"Gözler arası tomografi:",
    "CERAI BAD-D reference points":"CERAI BAD-D referans puanları","CERAI interpretation / action":"CERAI yorumu / eylemi","Published Randleman / ERSS scoring points":"Yayımlanmış Randleman / ERSS puanları",
  ...
  const CLINICAL = {
    ...
    "NICE interpretation: no NICE escalation. NICE is an independent screening pathway and is not added to the CERAI numeric score.":"NICE yorumu: NICE artırımı yoktur. NICE bağımsız bir tarama yoludur ve CERAI sayısal puanına eklenmez.",
  ...
  const translate = value => {
    ...
    return text
      .replace(/^CERAI SCORE — SOURCE & BREAKDOWN:/,"CERAI PUANI — KAYNAK VE DÖKÜM:")
      ...
      .replace(/This is not a clearance criterion and does not change the CERAI score or final disposition\./g,"Bu bir cerrahi onay ölçütü değildir ve CERAI puanını veya nihai kararı değiştirmez.")
      ...
      .replace(/NICE is an independent screening pathway and is not added to the CERAI numeric score\./g,"NICE bağımsız bir tarama yoludur ve CERAI sayısal puanına eklenmez.")
