...
(() => {
  ...
  const TR = {
    ...
    "ESCRS biometry file downloaded. In ESCRS choose Load Biometry, upload the JSON file, and verify every value.":"ESCRS biyometri dosyası indirildi. ESCRS'de Biyometri Yükle'yi seçin, JSON dosyasını yükleyin ve her değeri doğrulayın.",
