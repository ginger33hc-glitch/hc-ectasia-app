...
(() => {
  ...
  const TR = {
    ...
    "This is the published Placido-era Randleman/ERSS pattern classification adapted to CER-AI's locked anterior-curvature source rule. It is a risk-score input, not a stand-alone diagnosis. Source:":"Bu, CER-AI’nin kilitli ön eğrilik kaynak kuralına uyarlanmış, yayımlanmış Placido dönemi Randleman/ERSS patern sınıflandırmasıdır. Bir risk puanı girdisidir; tek başına tanı değildir. Kaynak:",
    ...
    "Analyze images and run CER-AI assessment":"Görüntüleri analiz et ve CER-AI değerlendirmesini çalıştır",
    ...
    "Independent pathways:":"Bağımsız yollar:","Active CER-AI pachymetry policy:":"Aktif CER-AI pakimetri politikası:","CER-AI modification:":"CER-AI değişikliği:","Inter-eye tomography:":"Gözler arası tomografi:",
    "CER-AI BAD-D reference points":"CER-AI BAD-D referans puanları","CER-AI interpretation / action":"CER-AI yorumu / eylemi","Published Randleman / ERSS scoring points":"Yayımlanmış Randleman / ERSS puanları",
