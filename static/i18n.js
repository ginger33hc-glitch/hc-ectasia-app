...
(() => {
  ...
  const TR = {
    ...
    "Pentacam region the application could not read":"Uygulamanın okuyamadığı Pentacam bölgesi",
    "The unread source region could not be displayed. Enter the value from the original Pentacam image.":"Okunamayan kaynak bölge gösterilemedi. Değeri özgün Pentacam görüntüsünden girin.",
